                    ...
                    value: function(b, a, c, e) {
                        if (a >= b.getSize()) e.onSuccess();
                            ...
                            if (0 == f || isNaN(f)) e.onSuccess();
                                ...
                                } else b.loadRange([a + f, a + f + 8], {
                                    onSuccess: function() {
                                        d._loadAtom(b, a + f, c, e)
                                    },
                                    onError: e.onError
                                })
                            }
                    ...
                    },
                    {
                        ...
                        value: function(a) {
                            if (a = this._getResponseHeader(a, "Content-Range")) {
                                ...
                                return {
                                    firstBytePosition: parseInt(c[1], 10),
                                    lastBytePosition: parseInt(c[2], 10),
                                    instanceLength: c[3] ? parseInt(c[3], 10) : null
                                }
                            }
                            return null
                        }
                        ...
                        value: function(a, d, f) {
                            ...
                            c._config.timeoutInSec && (g.timeout = 1E3 * c._config.timeoutInSec, g.ontimeout = function() {
                                if (f.onError) f.onError({
                                    type: "xhr",
                                    info: "Timeout after " + g.timeout / 1E3 + "s. Use jsmediatags.Config.setXhrTimeout to override.",
                                    xhr: g
                                })
                            });
                            g.open(a, this._url);
