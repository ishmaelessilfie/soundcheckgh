var WaveSurfer = {
    ...
    init: function(a) {
        this.params =
            WaveSurfer.util.extend({}, this.defaultParams, a);
        ...
        if (!this.mediaContainer) throw Error("Media Container element not found");
        this.savedVolume =
            0;
        this.isMuted = !1;
        this.tmpEvents = [];
        ...
        this.createDrawer();
        this.createBackend();
        this.skipArrayBuffer = this.isDestroyed = !1
    },
    setSkipArrayBuffer: function(a) {
        this.skipArrayBuffer = a
    },
    createDrawer: function() {
        ...
        this.drawer.on("waveComplete", function(b) {
            a.fireEvent("waveComplete", b)
        })
    },
    ...
    play: function(a, b) {
        this.fireEvent("interaction", this.play.bind(this, a, b));
    ...
    seekTo: function(a) {
        this.fireEvent("interaction", this.seekTo.bind(this,
            a));
    ...
    toggleMute: function() {
        this.isMuted ?
            (this.backend.setVolume(this.savedVolume), this.isMuted = !1) : (this.savedVolume = this.backend.getVolume(), this.backend.setVolume(0), this.isMuted = !0)
    },
    ...
    drawBuffer: function() {
        var a = Math.round(this.getDuration() * this.params.minPxPerSec * this.params.pixelRatio),
            ...
            c = a;
        this.params.fillParent && (!this.params.scrollParent || a <
            b) && (c = b);
        a = this.backend.getPeaks(c);
        this.drawer.drawPeaks(a, c);
        this.fireEvent("redraw", a, c)
    },
    zoom: function(a) {
    ...
    load: function(a, b, c) {
        "undefined" == typeof c && this.empty();
        switch (this.params.backend) {
            case "WebAudio":
                return this.loadBuffer(a, b);
            case "MediaElement":
                return this.loadMediaElement(a,
                    b)
        }
    },
    loadBuffer: function(a, b) {
        var c = function(b) {
            b && this.tmpEvents.push(this.once("ready", b));
            return this.getArrayBuffer(a, this.loadArrayBuffer.bind(this))
        }.bind(this);
        if (b) this.backend.setPeaks(b), this.drawBuffer(), this.tmpEvents.push(this.once("interaction", c));
        else return c()
    },
    loadMediaElement: function(a, b) {
        var c = a;
        "string" === typeof a ? this.backend.load(c, this.mediaContainer, b) : (this.backend.loadElt(a, b), c = a.src);
        this.tmpEvents.push(this.backend.once("canplay", function() {
                this.drawBuffer();
                this.fireEvent("ready")
            }.bind(this)),
            this.backend.once("error", function(a) {
                this.fireEvent("error", a)
            }.bind(this)));
        b ? this.backend.setPeaks(b) : this.backend.supportsWebAudio() && !this.skipArrayBuffer && this.getArrayBuffer(c, function(a) {
            this.decodeArrayBuffer(a, function(a) {
        ...
        this.skipArrayBuffer = !1
    },
    _getArrayBuffer: function(a) {
        this.getArrayBuffer(a, function(a) {
            this.decodeArrayBuffer(a, function(a) {
                this.backend.buffer = a;
                this.drawBuffer();
                this.fireEvent("waveform_ME_noPeaks")
    ...
    decodeArrayBuffer: function(a, b) {
        this.arraybuffer = a;
        this.backend.decodeArrayBuffer(a, function(c) {
    ...
    getArrayBuffer: function(a, b) {
        ...
        this.currentAjax = d;
        this.tmpEvents.push(d.on("progress", function(a) {
            c.onProgress(a)
        }), d.on("success", function(a, d) {
            b(a);
            c.currentAjax = null
        }), d.on("error", function(a) {
            c.fireEvent("error",
                "XHR error: " + a.target.statusText);
            c.currentAjax = null
        }));
        return d
    },
    onProgress: function(a) {
        this.fireEvent("loading", Math.round(100 * (a.lengthComputable ? a.loaded / a.total : a.loaded / (a.loaded + 1E6))), a.target)
    },
    exportPCM: function(a, b, c) {
        b = b || 1E4;
        c = c || !1;
        a = this.backend.getPeaks(a || 1024, b);
        a = [].map.call(a, function(a) {
            return Math.round(a * b) / b
        });
        a = JSON.stringify(a);
        c || window.open("data:application/json;charset=utf-8," + encodeURIComponent(a));
        return a
    },
    exportImage: function(a, b) {
        a || (a = "image/png");
        b || (b = 1);
        return this.drawer.getImage(a,
            b)
    },
    cancelAjax: function() {
    ...
    Observer: {
        ...
        un: function(a, b) {
            if (this.handlers) {
                ...
                if (c)
                    if (b)
                        for (var d = c.length - 1; 0 <= d; d--) c[d] == b && c.splice(d, 1);
                    else c.length = 0
            }
        },
        unAll: function() {
...
WaveSurfer.WebAudio = {
    ...
    getOfflineAudioContext: function(a) {
        WaveSurfer.WebAudio.offlineAudioContext || (WaveSurfer.WebAudio.offlineAudioContext = new(window.OfflineAudioContext ||
    ...
    setFilters: function(a) {
        ...
        a && a.length && (this.filters = a, this.analyser.disconnect(), a.reduce(function(a, c) {
            a.connect(c);
            return c
    ...
    addOnAudioProcess: function() {
        ...
        this.scriptNode.onaudioprocess = function() {
            ...
            b >= a.getDuration() ? (a.setState(a.FINISHED_STATE), a.fireEvent("pause")) : b >= a.scheduledPause ? a.pause() : a.state === a.states[a.PLAYING_STATE] &&
                a.fireEvent("audioprocess", b)
        }
    },
    ...
    getPeaks: function(a) {
        ...
        for (var b = this.buffer.length / a, c = ~~(b / 10) || 1, d = this.buffer.numberOfChannels, f = [], e = [], g = 0; g < d; g++)
            for (var k = f[g] = [], m = this.buffer.getChannelData(g), h = 0; h < a; h++) {
                for (var l = ~~(h * b), r = ~~(l + b), p = 0, n = 0; l < r; l += c) {
                    var q = m[l];
                    q > n && (n = q);
                    q < p && (p = q)
                }
                ...
                if (0 == g ||
                    n > e[2 * h]) e[2 * h] = n;
                if (0 == g || p < e[2 * h + 1]) e[2 * h + 1] = p
            }
        return this.params.splitChannels ? f : e
    },
    ...
    setPlaybackRate: function(a) {
        a = a || 1;
        this.isPaused() ? this.playbackRate = a : (this.pause(), this.playbackRate = a, this.play())
    }
};
...
WaveSurfer.util.extend(WaveSurfer.MediaElement, {
    ...
    createTimer: function() {
        var a = this,
            b = function() {
                a.isPaused() || (a.fireEvent("audioprocess", a.getCurrentTime()),
                    (window.requestAnimationFrame || window.webkitRequestAnimationFrame)(b))
            };
        this.on("play", b)
    },
    load: function(a, b, c) {
        if (this.singleMediaCreationDone) this.singleMediaCreation.src = a;
        else {
            var d = document.createElement(this.mediaType);
            d.controls = this.params.mediaControls;
            d.autoplay = this.params.autoplay || !1;
            d.preload = "auto";
            d.src = a;
            d.style.width = "100%";
            (a = b.querySelector(this.mediaType)) && b.removeChild(a);
            b.appendChild(d);
            this.singleMediaCreation = d
        }
        this._load(d, c)
    },
    ...
    _load: function(a, b) {
        var c = this;
        this.singleMediaCreation && (this.media = a = this.singleMediaCreation);
        this.canPlayDone = !1;
        a.load();
        this.singleMediaCreationDone || (a.addEventListener("error", function() {
            c.fireEvent("error", "Error loading media element")
        }), a.addEventListener("canplay", function() {
            c.canPlayDone || (c.fireEvent("canplay"), c.canPlayDone = !0)
        }), a.addEventListener("ended", function() {
            c.fireEvent("finish")
        }), this.singleMediaCreationDone = !0);
        this.peaks =
            b;
        this.buffer = this.onPlayEnd = null;
    ...
    getDuration: function() {
        ...
        Infinity <= a && (a = this.media.seekable.end(0));
        return a
    },
    getCurrentTime: function() {
    ...
    getPeaks: function(a) {
        return this.buffer ?
            WaveSurfer.WebAudio.getPeaks.call(this, a) : this.peaks || []
    },
    getVolume: function() {
    ...
    destroy: function() {
        ...
        this.singleMediaCreation = this.media = null;
        this.singleMediaCreationDone = !1
    }
});
...
WaveSurfer.Drawer = {
    ...
    handleEvent: function(a, b) {
        !b && a.preventDefault();
        var c = a.targetTouches ? a.targetTouches[0].clientX : a.clientX,
            d = this.wrapper.getBoundingClientRect(),
            f = this.width,
            e = this.getWidth();
        !this.params.fillParent && f < e ? (c = (c - d.left) * this.params.pixelRatio / f || 0, 1 < c && (c = 1)) : c = (c - d.left + this.wrapper.scrollLeft) / this.wrapper.scrollWidth || 0;
        return c
    },
    ...
    recenter: function(a) {
        this.recenterOnPosition(this.wrapper.scrollWidth * a, !0)
    },
    recenterOnPosition: function(a, b) {
        ...
        0 != g && (!b && -d <= e && e < d && (e = Math.max(-5, Math.min(5, e)), f = c + e), f = Math.max(0, Math.min(g, f)), f != c && (this.wrapper.scrollLeft = f))
    },
    getWidth: function() {
    ...
    progress: function(a) {
        ...
        if (c < this.lastPos || c - this.lastPos >= b) this.lastPos = c, this.params.scrollParent &&
            this.params.autoCenter && this.recenterOnPosition(~~(this.wrapper.scrollWidth * a)), this.updateProgress(a)
    },
    destroy: function() {
        this.unAll();
        this.wrapper && (this.container.removeChild(this.wrapper), this.wrapper = null)
    },
    initDrawer: function() {},
...
WaveSurfer.util.extend(WaveSurfer.Drawer.Canvas, {
    createElements: function() {
        this.waveCc = this.wrapper.appendChild(this.style(document.createElement("canvas"), {
            position: "absolute",
            zIndex: 1,
            left: 0,
            top: 0,
        ...
        this.params.waveColor != this.params.progressColor && (this.progressCc = this.progressWave.appendChild(document.createElement("canvas")).getContext("2d"))
    },
    updateSize: function() {
        ...
        this.progressCc && (this.progressCc.canvas.width = this.width, this.progressCc.canvas.height =
            this.height, this.style(this.progressCc.canvas, {
                width: a + "px"
            }));
        this.clearWave()
    },
    ...
    drawBars: function(a, b) {
        if (a[0] instanceof Array) {
            ...
            if (this.params.splitChannels) {
                this.setHeight(c.length * this.params.height * this.params.pixelRatio);
                c.forEach(this.drawBars, this);
                return
            }
            a = c[0]
        } [].some.call(a, function(a) {
            return 0 > a
        ...
        var d = .5 / this.params.pixelRatio,
            ...
            m = k + Math.max(this.params.pixelRatio, ~~(k / 2)),
            h = 1;
        this.params.normalize && (h = WaveSurfer.util.max(a));
        var l = c / f;
        ...
        [this.waveCc, this.progressCc].forEach(function(b) {
            if (b)
                for (var c = 0; c < f; c += m) {
                    var n = Math.round(a[Math.floor(c *
                        l)] / h * g);
                    b.fillRect(c + d, g - n + e, k + d, 2 * n)
                }
        }, this)
    },
    drawWave: function(a, b) {
        if (a[0] instanceof Array) {
            ...
            if (this.params.splitChannels) {
                this.setHeight(c.length * this.params.height * this.params.pixelRatio);
                c.forEach(this.drawWave, this);
                return
            }
            a = c[0]
        }
        if (![].some.call(a, function(a) {
                return 0 > a
            })) {
            for (var c = [], d = 0, f = a.length; d < f; d++) c[2 * d] = a[d], c[2 * d + 1] = -a[d];
            a = c
        }
        var e = .5 / this.params.pixelRatio,
            ...
            m = ~~(a.length / 2),
            h = 1;
        this.params.fillParent && this.width !=
            m && (h = this.width / m);
        var l = 1;
        this.params.normalize && (c = WaveSurfer.util.max(a), d = WaveSurfer.util.min(a), l = -d > c ? -d : c);
        this.waveCc.fillStyle = this.params.waveColor;
        this.progressCc && (this.progressCc.fillStyle = this.params.progressColor);
        [this.waveCc, this.progressCc].forEach(function(b) {
            if (b) {
                ...
                b.moveTo(e, k + g);
                for (var c = 0; c < m; c++) {
                    var d = Math.round(a[2 * c] / l * k);
                    b.lineTo(c * h + e, k - d + g)
                }
                for (c = m - 1; 0 <= c; c--) d = Math.round(a[2 * c + 1] / l * k), b.lineTo(c * h + e, k - d + g);
                b.closePath();
                b.fill();
                b.fillRect(0, k + g - e, this.width,
                    e)
            }
        }, this)
    },
    updateProgress: function(a) {
        this.style(this.progressWave, {
            width: Math.round(this.width * a) / this.params.pixelRatio + "px"
        })
    },
...
(function() {
    var a = function() {
        ...
        Array.prototype.forEach.call(a, function(a) {
            ...
            b = WaveSurfer.create(b);
            if (a.dataset.peaks) var f = JSON.parse(a.dataset.peaks);
            b.load(a.dataset.url, f)
        })
    };
